...
In this lab we will do a population projection exercise using the fertility, mortality and population data from the dataset explored in Lab: Exploration. We will then compare these results to the growth rate and population structure implied by stable population theory. 

## Read in data

We are using the same dataset from Lab: Exploration, which had fertility, mortality and population data for six different countries. Before using the data, change the units of $_nL_x$ to have a radix of 1 and $_nF_x$ to be births per woman.
